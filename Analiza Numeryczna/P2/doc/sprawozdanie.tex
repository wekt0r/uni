...
%\includegraphics[scale=0.7]{arithmeanpolyeq.png}
\captionof{figure}{Wykres średniej arytmetycznej błędów interpolacji dla 100 losowych wielomianów interpolowanych w 20 węzłach równoodległych (10 oraz pierwsze pochodne dla interpolacji Hermite'a)}
%\includegraphics[scale=0.7]{arithmeanpolyeqq.png}
\captionof{figure}{Wykres średniej arytmetycznej błędów interpolacji dla 100 losowych wielomianów interpolowanych w 30 węzłach równoodległych (15 oraz pierwsze pochodne dla interpolacji Hermite'a)}
